...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train a student LLM using knowledge distillation.")
    parser.add_argument("--dataset-path", type=str, required=True, help="Path to the JSONL dataset.")
    parser.add_argument("--output-dir", type=str, default="./student_model_distilled", help="Directory to save the trained model.")
    parser.add_argument("--student-model-name", type=str, default="microsoft/Phi-3-mini-4k-instruct")
    ...
    parser.add_argument("--loss-alpha", type=float, default=0.5, help="Weight for Cross-Entropy loss (0.0 to 1.0).")
